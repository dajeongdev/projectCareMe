...
public class DocterDto {
	...
	private int doctor_hospital_name;
	private int doctor_hospital_tel;
	private String docotor_hospital_address;
	...
	public int getDoctor_hospital_name() {
		return doctor_hospital_name;
	}
	public void setDoctor_hospital_name(int doctor_hospital_name) {
		this.doctor_hospital_name = doctor_hospital_name;
	}
	public int getDoctor_hospital_tel() {
		return doctor_hospital_tel;
	}
	public void setDoctor_hospital_tel(int doctor_hospital_tel) {
		this.doctor_hospital_tel = doctor_hospital_tel;
	}
	public String getDocotor_hospital_address() {
		return docotor_hospital_address;
	}
	public void setDocotor_hospital_address(String docotor_hospital_address) {
		this.docotor_hospital_address = docotor_hospital_address;
	}
	...
	public String toString() {
		return "DocterDto [doctor_idx=" + doctor_idx + ", member_idx=" + member_idx + ", doctor_name=" + doctor_name
				...
				+ ", docotor_hospital_address=" + docotor_hospital_address + ", doctor_hospital_zipcode="
